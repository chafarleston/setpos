...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Encargado', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Vendedor', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
...
CREATE TABLE PEOPLE (
    ...
    SSNUMBER VARCHAR(255),
    IDNEXP VARCHAR(255),
    SSNEXP VARCHAR(255),
    ACCNUMBER VARCHAR(255),
    BANK VARCHAR(255),
    BDATE VARCHAR(255),
    EMPSINCE VARCHAR(255),
    SALARY DOUBLE,
    SALARYHOUR DOUBLE,
    NOTES VARCHAR(255),
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Admin', NULL, '0', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Encargado', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Vendedor', NULL, '2', TRUE, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('32', 'openbravo.properties', 0, $FILE{/com/openbravo/pos/templates/openbravo.properties.txt});
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('0', 'Especiales');
INSERT INTO CATEGORIES(ID, NAME) VALUES ('-1', 'Compuestos');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'IVA 16%');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('-1', 'Compuestos');

CREATE TABLE TAXES (
    ID VARCHAR(255) NOT NULL,
    NAME VARCHAR(255) NOT NULL,
    VALIDFROM DATETIME DEFAULT '2000-01-01 00:00:00' NOT NULL,
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'IVA 16%', '001', NULL, NULL, 0.16, 0, NULL);
...
--//SET SOFTWARE UPDATE añade la columna de la razon
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Restaurante', $FILE{/com/openbravo/pos/templates/restaurantsample2.png});
...
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('1', 'Mesa 01', 133, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('2', 'Mesa 02', 266, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('3', 'Mesa 03', 399, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('4', 'Mesa 04', 532, 151, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('5', 'Mesa 05', 133, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('6', 'Mesa 06', 266, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('7', 'Mesa 07', 399, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('8', 'Mesa 08', 532, 264, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('9', 'Mesa 09', 133, 377, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('10', 'Mesa 10', 266, 377, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('11', 'Mesa 11', 399, 377, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('12', 'Mesa 12', 532, 377, '0');
...
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('1', 'Pausa Mañana', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('2', 'Pausa Tarde', TRUE, NULL);
